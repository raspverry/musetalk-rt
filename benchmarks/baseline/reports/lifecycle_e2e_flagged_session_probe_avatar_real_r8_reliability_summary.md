# Flagged E2E Reliability Summary (lifecycle_e2e_flagged_session_probe_avatar_real_r8)
...
- Before fallback rate: 1.0
- After fallback rate: 0.0
- Delta fallback rate: -1.0

### Stage-by-stage signal_kind mix
- **audio_accepted**: before={'proxy_command': 8} | after={'proxy_command': 8}
- **avatar_ready_or_warm_assumed**: before={'proxy_fallback_command': 8} | after={'real_wired_avatar_probe': 8}
- **first_speaking_frame_signal**: before={'real_wired_first_frame_observation': 8} | after={'real_wired_first_frame_observation': 8}
- **session_start**: before={'proxy_command': 8} | after={'proxy_command': 8}
