# Flagged E2E Quality Validation Summary (lifecycle_e2e_flagged_session_probe_audio_session_real_qv12)
...
- TTS cadence sensitivity sampled only for cadence profile: fixed.
